...
requirejs([
    ...
    const conString = conInformation.environment.production.connectionString;
    const dbName = conInformation.environment.production.dbName;
    ...
    function setAppPreferences() {
        var whiteList = conInformation.environment.production.cors;
